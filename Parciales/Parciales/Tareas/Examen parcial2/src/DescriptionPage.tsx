  ...
  return (
    <div className="description-container">
      ...
      <div className="centered-image">
        <img src="./public/Rick.png" alt="Rick and Morty" />
      </div>
      ...
      <div className="image-text-row">
        <div className="image-container">
          <img src="./public/R&M.jpeg" alt="Rick y Morty" />
        </div>
      ...
      <ul>
        <li>
          <strong>Rick Sánchez</strong>: Un científico brillante pero alcohólico y cínico.
        </li>
        <li>
          <strong>Morty Smith</strong>: El nieto de Rick, quien a menudo se ve arrastrado a las aventuras de su abuelo.
        </li>
        <li>
          <strong>Summer Smith</strong>: La hermana mayor de Morty.
        </li>
        <li>
          <strong>Beth Smith</strong>: La madre de Morty y la hija de Rick.
        </li>
        <li>
          <strong>Jerry Smith</strong>: El padre de Morty, inseguro y a menudo incapaz.
        </li>
      </ul>
    </div>
  );
